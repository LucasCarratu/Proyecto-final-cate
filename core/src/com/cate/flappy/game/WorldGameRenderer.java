...
public class  WorldGameRenderer {
    ...
    private void drawBird(float delta) {
        ...
        if (obj.state == Bird.STATE_NORMAL) {       //si el objeto esta en estado normal va a correr los 3 frames en loop
    ...
    private void drawBackground(float delta) {
        spriteBatch.draw(Assets.background, 0, 0, WIDTH, HEIGHT);       //se dibuja el fondo
    }
